...
n = [0]                                 # set lengths of vectors bounded in l2 norm
B = [1]    # set l2 norm bounds
#n = [64, 32, 32]                                 # set lengths of vectors bounded in l2 norm
#B = [sqrt(128*64), sqrt(128*32),sqrt(128*32)]    # set l2 norm bounds
